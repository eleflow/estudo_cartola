...
from airflow.cartola_api.requesters.athlete_requester import AthleteRequester
...
@pytest.mark.parametrize(
    ...
    [
        ([{"id":"38144","scouts":[{'CA': 1}, {'DS': 2}, {'FC': 2}, {'SG': 1}],"nickname":"Rafinha","picture":"https://s.sde.globo.com/media/person_role/2022/03/01/de7df71bb9091a8547f8d8bd0212b549_FORMATO.png","points":5.8,"position_id":2,"club_id":276,"played_the_game":True,"year":2023}], 
